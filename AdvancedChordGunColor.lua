...
local function getSuggestionColor(score)
  if score >= 0.55 then return {0.00,0.45,0.70,0.50} end   -- bright blue (best)
  if score >= 0.42 then return {0.20,0.55,0.80,0.38} end   -- medium blue (good)
  if score >= 0.30 then return {0.90,0.62,0.00,0.32} end   -- orange (decent)
  if score >= 0.20 then return {0.80,0.52,0.00,0.20} end   -- dim orange (possible)
  return nil
end
